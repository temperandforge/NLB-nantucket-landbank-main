...
**Design Token**:
A named, reusable design value (color, spacing, font size, etc.) defined once and referenced everywhere it applies. In this repo, design tokens live in the Tailwind `@theme` block in `frontend/app/globals.css`; Figma variables of the same purpose are reconciled against these via the mapping table below.
